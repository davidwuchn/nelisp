...
** Test status (HEAD, 2026-08-15)

- =make test= = *4865 tests / 4519 expected / 0 unexpected / 346 skipped*
  on the Windows host.  The skipped tests require unavailable standalone
  primitives, platform capabilities, or platform-specific toolchains.
